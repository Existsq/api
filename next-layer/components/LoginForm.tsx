  ...
  return (
    <div className="h-screen min-h-screen bg-white ">
        <form className="flex flex-col justify-start text-black gap-y-3 px-10 pt-20">
          <div className="mx-10 text-black text-2xl pb-2 text-left font-medium">Login with email</div>
            ...
            <input className="bg-blue-600 mx-10 min-h-12 rounded-xl text-white text-base px-4" type="submit" value="Login" />
        </form>
      </div>
  );
}
